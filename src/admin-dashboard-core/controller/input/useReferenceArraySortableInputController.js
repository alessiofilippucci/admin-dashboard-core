 ...
 * @example
 *
 * const { choices, error, loaded, loading } = useReferenceArraySortableInputController({
 *      basePath: 'resource';
 ...
 */
const useReferenceArraySortableInputController = ({
...
export default useReferenceArraySortableInputController;
