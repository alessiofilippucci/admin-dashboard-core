...
import { useTranslate, ValidationError } from 'admin-dashboard-core';
import classNames from 'classnames';
                ...
                isValidElement(input) ? (
                    <FormInput
                        ...
                        input={cloneElement(input, {
                            ...
                            disabled,
                            formClassName: classnames(input.formClassName, useBootstrap ? 'row' : ''),
                        })}
            ...
            <TransitionGroup component={null}>
                {fields.map((member, index) => (
                    <CSSTransition
                        ...
                        {...TransitionProps}
                    >
                        <li className={classNames(classes.line, hideBorders ? 'no-border' : '', floatLeft ? 'floatLeft' : '')}>
                            {
                            ...
                            {
                                useBootstrap ?
                                    <section className={classNames(classes.form, 'container-fluid')}>
