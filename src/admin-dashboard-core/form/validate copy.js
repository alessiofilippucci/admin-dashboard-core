 ...
 * Telephone validator
 *
 * Returns an error if the value is not setted true
 *
 * @param {string|Function} message
 *
 * @example
 *
 * const boolValidators = [bool('Must be true')];
 * <TextInput name="bool" validate={boolValidators} />
 */
export const bool = memoize(
    (message = 'ra.validation.bool') => (value, values) => {
