...
import useReferenceArraySortableInputController from './useReferenceArraySortableInputController';
 ...
 * </ReferenceArrayInput>
 */
const ReferenceArraySortableInputController = ({
    basePath,
    children,
    filter = {},
    input,
    ...
    const {
        ...
        setSort,
        warning,
    } = useReferenceArraySortableInputController({
        basePath,
        filter,
        filterToQuery,
        input,
...
export default ReferenceArraySortableInputController;
